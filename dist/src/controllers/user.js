...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const haspassword = yield bcrypt_1.default.hash(password, salt);
...
const loginWithGoogle = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (user) {
            ...
            const salt = yield bcrypt_1.default.genSalt(10);
            const haspassword = yield bcrypt_1.default.hash((0, generatorRandomText_1.generatorRandomText)(6), salt);
            body.password = haspassword;
            const newUser = new UserModel_1.default(body);
            yield newUser.save();
            delete newUser._doc.password;
